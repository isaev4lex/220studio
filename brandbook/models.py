...
class WorkSteps(models.Model):
    title = models.CharField(verbose_name='Заголовок этапа работы', max_length=500, blank=False, default='')
    text = models.TextField(verbose_name='Этап работы (текст)', blank=True, default='')
