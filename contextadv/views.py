...
def contextadv(request):
    ...
    data = {
        ...
        'tools': ContextAdvertisementTools.objects.all(),
        'tools_description': ContextAdvertisementDescription.objects.all(),
        'tools_possibilities': ContextAdvertisementPossibilities.objects.all(),
        'success_sent': False,
        'page': 'contextadv',
        'contact_info': {
    ...
    return render(request, 'contextadv/index.html', context=data)
